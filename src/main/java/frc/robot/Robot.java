...
public class Robot extends TimedRobot {
  ...
  CANSparkMax m_SPMX_1 = new CANSparkMax(2, MotorType.kBrushless);
  CANSparkMax m_SPMX_4 = new CANSparkMax(3, MotorType.kBrushless);
  
  Compressor pcmCompressor = new Compressor(0, PneumaticsModuleType.CTREPCM);
  DoubleSolenoid m_doubleSolenoid = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, 1, 2);  
  ...
  public void autonomousPeriodic() {
    switch (m_autoSelected) {
      case kCustomAuto:
        m_robotDrive.arcadeDrive(-0.1, -1);
        break;
      case kDefaultAuto:
      default:
        m_robotDrive.arcadeDrive(-0.1, -1);
